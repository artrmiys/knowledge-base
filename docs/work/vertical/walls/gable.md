...
- **Draft Stop** — отдельная строка (`1/2" Ply` / `5/8" Type X`), встречается в ~36%
  gable-секций корпуса и часто забывается; проверь по details/fire-rating notes.

## Таблица вывода

Source: `https://redacted.atlassian.net/wiki/spaces/work/pages/63799300/Gable`
