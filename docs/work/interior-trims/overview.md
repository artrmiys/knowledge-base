...
| Estimating exceptions | Kitchen cabinets, closets, garage, slope ceilings, no-finish rooms и `TBD` notes остаются project-specific estimating rules. | Topic rules |
